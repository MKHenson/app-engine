...
var ProjectModel = (function (_super) {
    ...
    */
    function ProjectModel() {
        ...
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("name", "", 1)).indexable(true);
        ...
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("category", "")).indexable(true);
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("subCategory", "basic")).indexable(true);
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.bool("public", false)).indexable(true);
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.id("curFile", "", true));
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.num("rating", 0)).indexable(true);
        ...
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.id("user", "", true)).indexable(true);
        ...
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.date("createdOn")).indexable(true);
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.date("lastModified")).indexable(true);
    }
    return ProjectModel;

module Animate
{
	...
	export class DB
    {
        ...
        public static API: string = "http://animate.webinate-test.net/app-engine";
		...
		public static PLAN_GOLD: string = "animate-gold";
		public static PLAN_PLATINUM: string = "animate-platinum";
	}
}
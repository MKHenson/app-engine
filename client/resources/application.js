...
(function (Animate) {
    ...
    var Utils = (function () {
        ...
        */
        Utils.createProperty = function (data, set) {
            ...
            switch (type) {
                case Animate.PropertyType.ASSET:
                    prop = new Animate.PropResource(null, null, null);
                    break;
                case Animate.PropertyType.ASSET_LIST:
                    prop = new Animate.PropResourceList(null, null, null);
                    break;
                case Animate.PropertyType.BOOL:
                    prop = new Animate.PropBool(null, null);
                    break;
                case Animate.PropertyType.ENUM:
                    prop = new Animate.PropEnum(null, null, null);
                    break;
                case Animate.PropertyType.FILE:
                    prop = new Animate.PropFileResource(null, null, null);
                    break;
                ...
                case Animate.PropertyType.STRING:
                    prop = new Animate.PropText(null, null);
                    break;
            }
            if (prop)
                prop.set = set;
    ...
    var EditableSet = (function () {
        ...
        */
        EditableSet.prototype.deTokenize = function (data) {
            ...
            items.splice(0, items.length);
            for (var t in data) {
                var prop = Animate.Utils.createProperty(data[t], this);
...
(function (Animate) {
    ...
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropResource = (function (_super) {
        __extends(PropResource, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        * @param {number} value The value of the property
        ...
        */
        function PropResource(name, value, classNames, category, options) {
        ...
        * @returns {any}
        */
        PropResource.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @param {any} data The data to import from
        */
        PropResource.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
...
(function (Animate) {
    ...
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropResourceList = (function (_super) {
        __extends(PropResourceList, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        ...
        * @param {any} options Any optional data to be associated with the property
        */
        function PropResourceList(name, value, classNames, category, options) {
        ...
        * @returns {any}
        */
        PropResourceList.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @param {any} data The data to import from
        */
        PropResourceList.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            this.classNames = data.classNames;
        };
        /**
        ...
        */
        PropResourceList.prototype.clone = function (clone) {
            return new PropResourceList(this.name, this._value, this.classNames, this.category, this.options);
        };
        return PropResourceList;
    })(Animate.Prop);
    Animate.PropResourceList = PropResourceList;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
...
(function (Animate) {
    ...
    */
    var Behaviour = (function (_super) {
        ...
        * @returns {Portal}
        */
        Behaviour.prototype.addPortal = function (type, property, update) {
            var portal = new Animate.Portal(this, type, property);
            this._requiresUpdated = true;
            // Add the arrays
    ...
    var BehaviourPortal = (function (_super) {
        ...
        */
        BehaviourPortal.prototype.deTokenize = function (data) {
            ...
            this._property = Animate.Utils.createProperty(data.portal.property, null);
        };
        /**
        * This will cleanup the component.
        */
...
(function (Animate) {
    ...
    */
    var Portal = (function (_super) {
        ...
        * @param {Prop<any>} property The property associated with this portal
        */
        function Portal(parent, type, property) {
            // Call super-class constructor
        ...
        */
        Portal.prototype.edit = function (property) {
            ...
            if (this._type == Animate.PortalType.INPUT)
                typeName = "Input";
        ...
        */
        Canvas.prototype.onContextSelect = function (e, event) {
            if (event.item.text == "Delete") {
                // Delete portal
                if (this._contextNode instanceof Animate.Portal) {
                    var behaviour = this._contextNode.behaviour;
                    behaviour.removePortal(this._contextNode);
                ...
                Animate.PortalForm.getSingleton().showForm(this._contextNode, null, null);
            }
                ...
                if (this._contextNode)
                    Animate.PortalForm.getSingleton().showForm(this._contextNode, type, null);
                else
        ...
        Canvas.prototype.OnPortalConfirm = function (response, e) {
            ...
            if (e.text == "Ok") {
                ...
                if (comp instanceof Animate.Portal) {
                    ...
                    var portal = comp.addPortal(Animate.PortalForm.getSingleton().portalType, Animate.PortalForm.getSingleton().getProperty(), true);
                    //PortalForm.getSingleton().name,
                    //PortalForm.getSingleton().value,
...
(function (Animate) {
    ...
    */
    var PropTextbox = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropTextbox.prototype.canEdit = function (prop) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropTextbox.prototype.edit = function (prop, container) {
            var p = prop;
            // Create HTML
...
(function (Animate) {
    ...
    */
    var PropNumber = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropNumber.prototype.canEdit = function (prop) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropNumber.prototype.edit = function (prop, container) {
            var p = prop;
            //Create HTML
            var num = p.getVal();
            var min = p.min;
...
(function (Animate) {
    ...
    */
    var PropComboBool = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropComboBool.prototype.canEdit = function (prop) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropComboBool.prototype.edit = function (prop, container) {
            var p = prop;
            // Create HTML	
...
(function (Animate) {
    ...
    */
    var PropComboEnum = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropComboEnum.prototype.canEdit = function (prop) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropComboEnum.prototype.edit = function (prop, container) {
            var p = prop;
            // Create HTML	
            var editor = jQuery("<div class='property-grid-label'>" + p.name + "</div><div class='property-grid-value'><select class='prop-combo'></select></div><div class='fix'></div>");
            var selector = jQuery("select", editor);
...
(function (Animate) {
    ...
    */
    var PropFile = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropFile.prototype.canEdit = function (prop) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropFile.prototype.edit = function (prop, container) {
            var p = prop;
...
(function (Animate) {
    ...
    */
    var PropComboGroup = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropComboGroup.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropResource == false && prop.getVal() instanceof Animate.GroupArray)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropComboGroup.prototype.edit = function (prop, container) {
            var p = prop;
            //Create HTML	
...
(function (Animate) {
    ...
    */
    var PropComboAsset = (function (_super) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropComboAsset.prototype.edit = function (prop, container) {
            var p = prop;
            // Create HTML	
            var editor = jQuery("<div class='property-grid-label'>" + p.name + "</div><div class='property-grid-value'><select class='prop-combo' style = 'width:90%;'></select><div class='eye-picker'><img src='media/eye.png' /></div></div><div class='fix'></div>");
            var selector = jQuery("select", editor);
...
(function (Animate) {
    ...
    */
    var PropAssetList = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropAssetList.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropResourceList)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropAssetList.prototype.edit = function (prop, container) {
            var p = prop;
            // Create HTML	
...
(function (Animate) {
    ...
    */
    var PropColorPicker = (function (_super) {
        ...
        * @returns {boolean}
        */
        PropColorPicker.prototype.canEdit = function (prop) {
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PropColorPicker.prototype.edit = function (prop, container) {
            var p = prop;
    ...
    var PortalForm = (function (_super) {
        ...
        */
        PortalForm.prototype.getProperty = function () {
            return new Animate.Prop(this._name.val.text, this._value);
        };
        PortalForm.prototype.showForm = function (item, type, caption) {
            ...
            if (item instanceof Animate.Portal) {
                type = item.type;
                caption = "Edit " + item.property.name;
            }
            this._portalType = type;
            this._name.val.text = (item instanceof Animate.Portal ? item.property.name : "");
            this._item = item;
            this._warning.textfield.element.css("color", "");
            this._warning.text = "";
            // Fill types
            ...
            if (type == Animate.PortalType.OUTPUT || type == Animate.PortalType.INPUT) {
                ...
                if (item instanceof Animate.Portal)
                    this._typeCombo.selectedItem = (item.property.type).toString();
            ...
            if (jQuery(e.target).text() == "Ok") {
                ...
                if (this._item instanceof Animate.Behaviour || this._item instanceof Animate.Portal) {
                    ...
                    for (var i = 0; i < behaviour.portals.length; i++) {
                        if (behaviour.portals[i].property.name == newName && (this._item instanceof Animate.Portal && this._item.property.name != behaviour.portals[i].property.name)) {
        ...
        Object.defineProperty(PortalForm.prototype, "parameterType", {
            get: function () {
                if (this._typeCombo.selectedItem)
                    return parseInt(this._typeCombo.selectedItem);
                else
...
/// <reference path="./definitions/es6-promise.d.ts" />
/// <reference path="./custom-definitions/engine-definitions.d.ts" />
/// <reference path="./custom-definitions/external-interfaces.d.ts" />
...
/// <reference path="lib/core/Events.ts" />
...
/// <reference path="lib/core/properties/EditableSet.ts" />
...
/// <reference path="lib/gui/canvas-items/CanvasItem.ts" />

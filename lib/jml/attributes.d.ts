/**
 * Base interface for dom attributes
 */
export interface DOMAttributes {
    ...
    onariarequest?: ( this: HTMLElement, ev: AriaRequestEvent ) => any;
    oncommand?: ( this: HTMLElement, ev: CommandEvent ) => any;
    ongotpointercapture?: ( this: HTMLElement, ev: PointerEvent ) => any;
    onlostpointercapture?: ( this: HTMLElement, ev: PointerEvent ) => any;
    onmsgesturechange?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmsgesturedoubletap?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmsgestureend?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmsgesturehold?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmsgesturestart?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmsgesturetap?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmsgotpointercapture?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmsinertiastart?: ( this: HTMLElement, ev: MSGestureEvent ) => any;
    onmslostpointercapture?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointercancel?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointerdown?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointerenter?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointerleave?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointermove?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointerout?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointerover?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    onmspointerup?: ( this: HTMLElement, ev: MSPointerEvent ) => any;
    ontouchcancel?: ( ev: TouchEvent ) => any;
    ontouchend?: ( ev: TouchEvent ) => any;
    ontouchmove?: ( ev: TouchEvent ) => any;
    ontouchstart?: ( ev: TouchEvent ) => any;
    onwebkitfullscreenchange?: ( this: HTMLElement, ev: Event ) => any;
    onwebkitfullscreenerror?: ( this: HTMLElement, ev: Event ) => any;
}

/**
 * Describes the css properties that can be used on JML style attribute
 */
...
/**
 * A non-exhaustive list of attributes that can be used as JML function attributes
 */

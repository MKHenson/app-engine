// Based on https://github.com/aldipower/nodejs-recaptcha
 ...
 */
export class reCaptcha extends events.EventEmitter
{
	private _recaptcha_response: any;
	...
	_httpPostRequest( postdata: string )
	{
		var that = this;

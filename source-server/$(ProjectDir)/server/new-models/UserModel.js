...
var UserDetailsModel = (function (_super) {
    ...
    */
    function UserDetailsModel() {
        ...
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("user", "", 1)).indexable(true);
        ...
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("plan", "", undefined, undefined, true));
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("website", ""));
        this.defaultSchema.add(new modepress_api_1.SchemaFactory.text("customerId", "", undefined, undefined, true));

...
(function (Animate) {
    ...
    (function (EventTypes) {
        ...
        // Plugin events
        EventTypes.CONTAINER_SELECTED = "container-selected";
        EventTypes.CONTAINER_CREATED = "container-created";
    ...
    */
    var ProjectResource = (function (_super) {
        ...
        function ProjectResource(entry) {
            ...
            this.entry = entry;
            var resource = entry;
            resource.shallowId = Animate.Utils.generateLocalId(resource.shallowId);
            this._saved = true;
            this._options = {};
        ...
        */
        ...
        Object.defineProperty(ProjectResource.prototype, "saved", {
            /**
            ...
            */
            set: function (val) {
                this._saved = val;
                this.emit(new Animate.Event("modified"));
            },
            enumerable: true,
            configurable: true
        });
...
(function (Animate) {
    ...
    */
    ...
    var ContainerEvent = (function (_super) {
        ...
        function ContainerEvent(type, container) {
            _super.call(this, type, null);
    ...
    */
    var PortalEvent = (function (_super) {
        __extends(PortalEvent, _super);
        function PortalEvent(type, oldName, container, portal) {
            _super.call(this, type, null);
            this.container = container;
            this.portal = portal;
            this.oldName = oldName;
    ...
    Animate.PortalEvent = PortalEvent;
    ...
    var EditEvent = (function (_super) {
        __extends(EditEvent, _super);
        function EditEvent(property, set) {
            _super.call(this, "edited");
            this.property = property;
            this.set = set;
        }
        return EditEvent;
    })(Animate.Event);
    Animate.EditEvent = EditEvent;
    ...
    */
    var ProjectEvent = (function (_super) {
        ...
        function ProjectEvent(type, resource) {
            this.resource = resource;
            _super.call(this, type, null);
        }
        return ProjectEvent;
    ...
    var AssetClass = (function () {
        ...
        */
        AssetClass.prototype.buildVariables = function () {
            var toRet = new Animate.EditableSet(null);
            var topClass = this;
            while (topClass != null) {
        ...
        */
        AssetClass.prototype.addVar = function (prop) {
...
(function (Animate) {
    ...
    var Utils = (function () {
        ...
        * @returns {number}
        */
        Utils.generateLocalId = function (reference) {
        ...
        Utils.createItem = function (parent, data) {
            switch (data.type) {
                ...
                case Animate.CanvasItemType.BehaviourScript:
                    return new Animate.BehaviourScript(parent, data.scriptId, data.text, false);
        ...
        */
        Utils.createProperty = function (name, type) {
            var prop;
            switch (type) {
                case Animate.PropertyType.ASSET:
                    prop = new Animate.PropAsset(name, null);
                    break;
                case Animate.PropertyType.ASSET_LIST:
                    prop = new Animate.PropAssetList(name, null, []);
                    break;
                case Animate.PropertyType.BOOL:
                    prop = new Animate.PropBool(name, false);
                    break;
                case Animate.PropertyType.ENUM:
                    prop = new Animate.PropEnum(name, "", []);
                    break;
                case Animate.PropertyType.FILE:
                    prop = new Animate.PropFileResource(name, null, null);
                    break;
                case Animate.PropertyType.COLOR:
                    prop = new Animate.PropColor(name, 0xffffff, 1);
                    break;
                case Animate.PropertyType.GROUP:
                    prop = new Animate.PropGroup(name, null);
                    break;
                //TODO: We dont have hidden props yet
                case Animate.PropertyType.HIDDEN:
                    break;
                //TODO: We dont have hidden props yet
                case Animate.PropertyType.HIDDEN_FILE:
                    break;
                case Animate.PropertyType.NUMBER:
                    prop = new Animate.PropNum(name, 0);
                    break;
                case Animate.PropertyType.OBJECT:
                    prop = new Animate.PropObject(name, null);
                    break;
                //TODO: We dont have objecy props yet
                case Animate.PropertyType.OPTIONS:
                    break;
                case Animate.PropertyType.STRING:
                    prop = new Animate.PropText(name, "");
                    break;
            }
            return prop;
        };
        ...
        */
        ImportExport.prototype.referenceCheckAsset = function (asset, container) {
            ...
            for (var i = 0, l = assetVars.length; i < l; i++) {
                if (assetVars[i].type == Animate.PropertyType.ASSET) {
                    var asset = assetVars[i].getVal();
                    if (asset) {
                ...
                else if (assetVars[i].type == Animate.PropertyType.ASSET_LIST) {
                    var aList = assetVars[i].getVal();
                ...
                else if (assetVars[i].type == Animate.PropertyType.GROUP) {
                    var group = assetVars[i].getVal();
                    if (group) {
                        var groupNode = Animate.TreeViewScene.getSingleton().findNode("resource", group);
            ...
            for (var ii = 0; ii < group.children.length; ii++)
                if (group.children[ii].shallowId) {
                    ...
                    if (container.assets.indexOf(assetID) == -1) {
                        ...
                        //It can also the be case that assets reference other assets. In those
                        //situations you will want the container to keep adding to all the assets
                        this.referenceCheckAsset(project.getResourceByShallowID(assetID, Animate.ResourceType.ASSET), container);
                    }
                }
        };
        ///**
            ...
            if (response == Animate.LoaderEvents.COMPLETE) {
                if (event.return_type == Animate.AnimateLoaderResponses.SUCCESS) {
                    if (loader.url == "/export/compile") {
                        ...
                        var now = new Date();
                        Animate.Logger.logMessage("Build complete at " + new Date(Date.now()).toDateString(), null, Animate.LogType.MESSAGE);
                        Animate.Logger.logMessage("External link: " + event.tag.liveLink, null, Animate.LogType.MESSAGE);
                        if (this.runWhenDone)
                        ...
                        this.emit(new Animate.ImportExportEvent(ImportExportEvents.COMPLETE, event.tag.liveLink));
                    }
                }
                else {
...
(function (Animate) {
    ...
    */
    var PropertyGridEditor = (function () {
        ...
        */
        PropertyGridEditor.prototype.edit = function (prop, container) {
            return null;
        };
        ///**
...
(function (Animate) {
    ...
    */
    var Asset = (function (_super) {
        ...
        */
        function Asset(assetClass, entry) {
            // Call super-class constructor
    ...
    var Container = (function (_super) {
        ...
        */
        function Container(entry) {
            ...
            _super.call(this, entry);
            this.canvas = null;
            this._properties.addVar(new Animate.PropBool("Start On Load", true, "Container Properties"));
        ...
        */
        Container.prototype.dispose = function () {
            this.emit(new Animate.ContainerEvent(Animate.EventTypes.CONTAINER_DELETED, this));
            //Call super
            _super.prototype.dispose.call(this);
            this.canvas = null;
        };
...
(function (Animate) {
    ...
    */
    var GroupArray = (function (_super) {
        ...
        */
        GroupArray.prototype.addReference = function (shallowId) {
        ...
        * @param {number} shallowId
        */
        GroupArray.prototype.removeReference = function (shallowId) {
...
(function (Animate) {
    ...
    */
    var BehaviourDefinition = (function () {
        ...
        */
        BehaviourDefinition.prototype.portalsTemplates = function () {
...
(function (Animate) {
    ...
    */
    var PortalTemplate = (function () {
        ...
        */
        function PortalTemplate(property, type) {
            this.type = type;
            this.property = property;
        }
    ...
    var Project = (function (_super) {
        ...
        */
        function Project() {
            ...
            this._groups = [];
            this._restPaths = {};
            this._restPaths[Animate.ResourceType.FILE] = { url: Animate.DB.API + "/files", array: this._files };
            this._restPaths[Animate.ResourceType.ASSET] = { url: Animate.DB.API + "/assets", array: this._assets };
            this._restPaths[Animate.ResourceType.CONTAINER] = { url: Animate.DB.API + "/containers", array: this._containers };
            this._restPaths[Animate.ResourceType.GROUP] = { url: Animate.DB.API + "/groups", array: this._groups };
            this._restPaths[Animate.ResourceType.SCRIPT] = { url: Animate.DB.API + "/scripts", array: this._scripts };
        }
        /**
        ...
        */
        Project.prototype.getResourceByID = function (id, type) {
        ...
        */
        Project.prototype.getResourceByShallowID = function (id, type) {
            var types = this._restPaths;
            if (type) {
                for (var i = 0, arr = types[type].array, l = arr.length; i < l; i++)
        ...
        */
        Project.prototype.createResourceInstance = function (entry, type) {
            var resource;
            if (type == Animate.ResourceType.ASSET) {
                var aClass = Animate.PluginManager.getSingleton().getAssetClass(entry.className);
                resource = new Animate.Asset(aClass, entry);
                this._assets.push(resource);
            }
            else if (type == Animate.ResourceType.SCRIPT) {
                resource = new Animate.ScriptResource(entry);
                this._scripts.push(resource);
            }
            else if (type == Animate.ResourceType.CONTAINER) {
                resource = new Animate.Container(entry);
                this._containers.push(resource);
            }
            else if (type == Animate.ResourceType.GROUP) {
                resource = new Animate.GroupArray(entry);
                this._groups.push(resource);
            }
            else if (type == Animate.ResourceType.FILE) {
                resource = new Animate.FileResource(entry);
                this._files.push(resource);
            }
            resource.initialize();
            this.emit(new Animate.ProjectEvent("resource-created", resource));
            return resource;
        };
        /**
        ...
        */
        Project.prototype.loadResources = function (type) {
            ...
            if (!type) {
                ...
                arr.push(Animate.Utils.get(paths[Animate.ResourceType.FILE].url + "/" + this.entry.user + "/" + this.entry._id));
                arr.push(Animate.Utils.get(paths[Animate.ResourceType.ASSET].url + "/" + this.entry.user + "/" + this.entry._id));
                arr.push(Animate.Utils.get(paths[Animate.ResourceType.CONTAINER].url + "/" + this.entry.user + "/" + this.entry._id));
                arr.push(Animate.Utils.get(paths[Animate.ResourceType.GROUP].url + "/" + this.entry.user + "/" + this.entry._id));
                arr.push(Animate.Utils.get(paths[Animate.ResourceType.SCRIPT].url + "/" + this.entry.user + "/" + this.entry._id));
            }
            else {
                // Send delete events for all existing resources
                ...
                Promise.all(arr).then(function (data) {
                    ...
                    if (!type) {
                        for (var i = 0, l = data[0].data.length; i < l; i++)
                            createdResources.push(that.createResourceInstance(data[0].data[i], Animate.ResourceType.FILE));
                        for (var i = 0, l = data[1].data.length; i < l; i++)
                            createdResources.push(that.createResourceInstance(data[1].data[i], Animate.ResourceType.ASSET));
                        for (var i = 0, l = data[2].data.length; i < l; i++)
                            createdResources.push(that.createResourceInstance(data[2].data[i], Animate.ResourceType.CONTAINER));
                        for (var i = 0, l = data[3].data.length; i < l; i++)
                            createdResources.push(that.createResourceInstance(data[3].data[i], Animate.ResourceType.GROUP));
                        for (var i = 0, l = data[4].data.length; i < l; i++)
                            createdResources.push(that.createResourceInstance(data[4].data[i], Animate.ResourceType.SCRIPT));
                    }
                    else {
                        if (type == Animate.ResourceType.FILE)
                            for (var i = 0, l = data[0].data.length; i < l; i++)
                                createdResources.push(that.createResourceInstance(data[0].data[i], Animate.ResourceType.FILE));
                        else if (type == Animate.ResourceType.ASSET)
                            for (var i = 0, l = data[0].data.length; i < l; i++)
                                createdResources.push(that.createResourceInstance(data[0].data[i], Animate.ResourceType.ASSET));
                        else if (type == Animate.ResourceType.CONTAINER)
                            for (var i = 0, l = data[0].data.length; i < l; i++)
                                createdResources.push(that.createResourceInstance(data[0].data[i], Animate.ResourceType.CONTAINER));
                        else if (type == Animate.ResourceType.GROUP)
                            for (var i = 0, l = data[0].data.length; i < l; i++)
                                createdResources.push(that.createResourceInstance(data[0].data[i], Animate.ResourceType.GROUP));
                        else if (type == Animate.ResourceType.SCRIPT)
                            for (var i = 0, l = data[0].data.length; i < l; i++)
                                createdResources.push(that.createResourceInstance(data[0].data[i], Animate.ResourceType.SCRIPT));
                    }
        ...
        */
        Project.prototype.editResource = function (id, data, type) {
            var that = this;
            var details = Animate.User.get.entry;
            var projId = this.entry._id;
            var paths = this._restPaths;
            var url = paths[type].url + "/" + details.username + "/" + projId + "/" + id;
            ...
            return new Promise(function (resolve, reject) {
                Animate.Utils.put(url, data).then(function (response) {
                    if (response.error)
                        return reject(new Error(response.message));
                    for (var t in data)
        ...
        */
        Project.prototype.saveResource = function (id, type) {
            var paths = this._restPaths;
            var that = this;
            var details = Animate.User.get.entry;
            var projId = this.entry._id;
        ...
        * @returns {Promise<boolean>}
        */
        Project.prototype.saveResources = function (type) {
            var paths = this._restPaths;
            var promises = [];
        ...
        * @returns {Promise<boolean>}
        */
        Project.prototype.deleteResource = function (id, type) {
            var that = this;
            var details = Animate.User.get.entry;
            var projId = this.entry._id;
            var paths = this._restPaths;
            ...
            if (!resource)
                return Promise.reject(new Error("No resource with that ID exists"));
            return new Promise(function (resolve, reject) {
                Animate.Utils.delete(url).then(function (response) {
                    if (response.error)
                        return reject(new Error(response.message));
                    array.splice(array.indexOf(resource), 1);
                    resource.emit(new Animate.Event("deleted"));
                    return resolve(true);
                }).catch(function (err) {
                    reject(new Error("An error occurred while connecting to the server. " + err.status + ": " + err.message));
                });
        ...
        */
        Project.prototype.copyResource = function (id, type) {
            var r = this.getResourceByID(id, type);
            var resource = r.resource;
            // Clone the resource and assign a new id
            var dataClone = JSON.parse(JSON.stringify(resource));
            dataClone.shallowId = Animate.Utils.generateLocalId();
            // Create a new resource with the data
            return this.createResource(type, dataClone);
        };
        /**
        ...
        * @returns {Promise<boolean>}
        */
        Project.prototype.deleteResources = function (ids) {
            var promises = [];
            var paths = this._restPaths;
            for (var t in paths)
        ...
        */
        Project.prototype.createResource = function (type, data) {
            var that = this;
            var details = Animate.User.get.entry;
            var projId = this.entry._id;
            var paths = this._restPaths;
            var url = paths[type].url + "/" + details.username + "/" + projId;
            return new Promise(function (resolve, reject) {
                Animate.Utils.post(url, data).then(function (data) {
                    ...
                    var resource;
                    if (type == Animate.ResourceType.ASSET)
                        resource = that.createResourceInstance(data.data, Animate.ResourceType.ASSET);
                    else if (type == Animate.ResourceType.CONTAINER)
                        resource = that.createResourceInstance(data.data, Animate.ResourceType.CONTAINER);
                    else if (type == Animate.ResourceType.GROUP)
                        resource = that.createResourceInstance(data.data, Animate.ResourceType.GROUP);
                    else if (type == Animate.ResourceType.SCRIPT)
                        resource = that.createResourceInstance(data.data, Animate.ResourceType.SCRIPT);
...
(function (Animate) {
    ...
    */
    var FileUploader = (function () {
        ...
        */
        function FileUploader(onProg, onComp) {
            this.percent = 0;
            this._dCount = 0;
            this._onProg = onProg;
        ...
        Object.defineProperty(FileUploader.prototype, "numDownloads", {
            /*
...
(function (Animate) {
    ...
    */
    var EditableSet = (function () {
        ...
        * @param {Prop<any>} prop
        */
        EditableSet.prototype.addVar = function (prop) {
        ...
        * @param {string} prop
        */
        EditableSet.prototype.removeVar = function (name) {
            var items = this._variables;
            for (var i = 0, l = items.length; i < l; i++)
                if (items[i].name == name) {
                    items[i].set = null;
        ...
        */
        EditableSet.prototype.notifyEdit = function (prop) {
            this.parent.emit(new Animate.EditEvent(prop, this));
        };
        /**
        ...
        */
        EditableSet.prototype.tokenize = function (slim) {
        ...
        */
        EditableSet.prototype.deTokenize = function (data) {
            var toRet = {};
            var items = this._variables;
            items.splice(0, items.length);
            for (var t in data) {
                var prop = Animate.Utils.createProperty(data[t].name, data[t].type);
                prop.set = this;
         ...
         */
        EditableSet.prototype.dispose = function () {
            this._variables = null;
            this.parent = null;
        };
        return EditableSet;
...
(function (Animate) {
    ...
    */
    var Prop = (function () {
        ...
        */
        function Prop(name, value, category, options, type) {
            if (type === void 0) { type = Animate.PropertyType.OBJECT; }
            this.name = name;
            this._value = value;
        ...
        * @returns {T}
        */
        Prop.prototype.getVal = function () {
            return this._value;
        };
        /**
        * Tokenizes the data into a JSON.
        ...
        * @returns {any}
        */
        Prop.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return this._value;
            else
        ...
        * @param {any} data The data to import from
        */
        Prop.prototype.deTokenize = function (data) {
        ...
        * @param {T} val
        */
        Prop.prototype.setVal = function (val) {
            this._value = val;
...
(function (Animate) {
    ...
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropEnum = (function (_super) {
        __extends(PropEnum, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        * @param {string} value The value of the property
        ...
        * @param {any} options [Optional] Any optional data to be associated with the property
        */
        function PropEnum(name, value, choices, category, options) {
            _super.call(this, name, value, category, options, Animate.PropertyType.ENUM);
       ...
       * @returns {any}
       */
        PropEnum.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @returns {PropEnum}
        */
        PropEnum.prototype.clone = function (clone) {
       ...
       * @param {any} data The data to import from
       */
        PropEnum.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            this.choices = data.choices;
        };
        return PropEnum;
    })(Animate.Prop);
    Animate.PropEnum = PropEnum;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropFileResource = (function (_super) {
        __extends(PropFileResource, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        * @param {string} value The value of the property
        ...
        * @param {any} options [Optional] Any optional data to be associated with the property
        */
        function PropFileResource(name, value, extensions, category, options) {
            _super.call(this, name, value, category, options, Animate.PropertyType.FILE);
        ...
        */
        PropFileResource.prototype.clone = function (clone) {
       ...
       * @returns {any}
       */
        PropFileResource.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
       ...
       * @param {any} data The data to import from
       */
        PropFileResource.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            this.extensions = data.extensions;
        };
        return PropFileResource;
    })(Animate.Prop);
    Animate.PropFileResource = PropFileResource;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropNum = (function (_super) {
        __extends(PropNum, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        ...
        * @returns {number}
        */
        PropNum.prototype.getVal = function () {
        ...
        * @returns {any}
        */
        PropNum.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @returns {PropNum}
        */
        PropNum.prototype.clone = function (clone) {
...
(function (Animate) {
    ...
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropAsset = (function (_super) {
        __extends(PropAsset, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        * @param {number} value The value of the property
        ...
        */
        function PropAsset(name, value, classNames, category, options) {
            if (classNames === void 0) { classNames = []; }
            _super.call(this, name, value, category, options, Animate.PropertyType.ASSET);
        ...
        * @returns {any}
        */
        PropAsset.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @param {any} data The data to import from
        */
        PropAsset.prototype.deTokenize = function (data) {
            // Gets the actual resource from the saved shallowId
            data.value = Animate.User.get.project.getResourceByShallowID(data.value);
            _super.prototype.deTokenize.call(this, data);
...
(function (Animate) {
    ...
    */
    var PropGroup = (function (_super) {
        ...
        * @param {any} options Any optional data to be associated with the property
        */
        function PropGroup(name, value, category, options) {
            _super.call(this, name, value, category, options, Animate.PropertyType.GROUP);
        }
        /**
        * Tokenizes the data into a JSON.
        * @param {boolean} slim If true, only the core value is exported. If false, additional data is exported so that it can be re-created at a later stage.
        * @returns {any}
        */
        PropGroup.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @param {any} data The data to import from
        */
        PropGroup.prototype.deTokenize = function (data) {
            // Gets the actual resource from the saved shallowId
            data.value = Animate.User.get.project.getResourceByShallowID(data.value);
            _super.prototype.deTokenize.call(this, data);
        };
...
(function (Animate) {
    ...
    */
    var PropAssetList = (function (_super) {
        ...
        * @param {any} options Any optional data to be associated with the property
        */
        function PropAssetList(name, value, classNames, category, options) {
            _super.call(this, name, value, category, options, Animate.PropertyType.ASSET_LIST);
            this.classNames = classNames;
        }
        /**
        * Tokenizes the data into a JSON.
        ...
        * @returns {any}
        */
        PropAssetList.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
                return _super.prototype.tokenize.call(this, slim);
            var token = _super.prototype.tokenize.call(this, slim);
        ...
        * @param {any} data The data to import from
        */
        PropAssetList.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            this.classNames = data.classNames;
        };
        /**
        ...
        */
        PropAssetList.prototype.clone = function (clone) {
...
(function (Animate) {
    ...
    * Defines a property variable. These are variables wrapped in sugar code to help sanitize and differentiate different pieces of data
    */
    var PropColor = (function (_super) {
        __extends(PropColor, _super);
        /**
        * Creates a new instance
        * @param {string} name The name of the property
        ...
        * @param {any} options [Optional] Any optional data to be associated with the property
        */
        function PropColor(name, color, alpha, category, options) {
            if (alpha === void 0) { alpha = 1; }
            _super.call(this, name, new Color(color, alpha), category, options, Animate.PropertyType.COLOR);
        }
        /**
        * Tokenizes the data into a JSON.
        * @param {boolean} slim If true, only the core value is exported. If false, additional data is exported so that it can be re-created at a later stage.
        * @returns {any}
        */
        PropColor.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            if (slim)
        ...
        * @returns {PropColor}
        */
        PropColor.prototype.clone = function (clone) {
        ...
        * @param {any} data The data to import from
        */
        PropColor.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            this._value = new Color(data.color, data.alpha);
        };
        return PropColor;
    })(Animate.Prop);
    Animate.PropColor = PropColor;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
...
(function (Animate) {
    ...
    */
    var Logger = (function (_super) {
        ...
        */
        Logger.logMessage = function (val, tag, type) {
    ...
    var Window = (function (_super) {
        ...
        */
        Window.prototype.hide = function () {
            ...
            this.emit(new Animate.WindowEvent(WindowEvents.HIDDEN, this));
        };
        /**
        ...
        */
        Window.prototype.show = function (parent, x, y, isModal, isPopup) {
            ...
            this.emit(new Animate.WindowEvent(WindowEvents.SHOWN, this));
            if (this._controlBox)
        ...
        */
        ContextMenu.prototype.onStageClick = function (e) {
            ...
            if (targ.is(jQuery(".context-item"))) {
                ...
                this.emit(new Animate.ContextMenuEvent(item, ContextMenuEvents.ITEM_CLICKED));
                this.hide();
                e.preventDefault();
                return;
            }
                        ...
                        if (comp.element.parent().data("component") == this._selectedNodes[0].element.parent().data("component")) {
                            ...
                            for (var i = 0; pNode.children.length; i++) {
                                ...
                                if (startSelecting || pNode.children[i] == this._selectedNodes[0]) {
                                    startSelecting = true;
                                    this.selectNode(pNode.children[i], false, true);
    ...
    */
    var Tab = (function (_super) {
        ...
        function Tab(parent) {
            ...
            this._tabSelectorsDiv = new Animate.Component("<div class='tabs-div'></div>", this);
            this._pagesDiv = new Animate.Component("<div class='pages-div'></div>", this);
            this._dropButton = new Animate.Component("<div class='tabs-drop-button black-tint'>&#x21E3;</div>", null);
            this._pagesDiv.addLayout(new Animate.Fill(0, 0, 0, -25));
            this._tabPairs = [];
        ...
        */
        Tab.prototype.onTabSelected = function (tab) {
            var event = new Animate.TabEvent(TabEvents.SELECTED, tab);
            this.emit(event);
        ...
        */
        Tab.prototype.onClick = function (e) {
            ...
            if (targ.is(jQuery(".tab-close"))) {
                ...
                var len = this._tabPairs.length;
                for (var i = 0; i < len; i++)
                    Tab.contextMenu.addItem(new Animate.ContextMenuItem(this._tabPairs[i].name, null));
                e.preventDefault();
        ...
        */
        ...
        Tab.prototype.addTab = function (val, canClose) {
            ...
            var page = new Animate.Component("<div class='tab-page background'></div>", this._pagesDiv);
            var tab = new Animate.Component("<div class='tab-selector animate-fast background-dark tab-selected'><div class='text'><span class='content'>" + (val instanceof Animate.TabPair ? val.name : val) + "</span></div></div>", this._tabSelectorsDiv);
            if (canClose) {
        ...
        */
        ...
        Tab.prototype.removeTab = function (val, dispose) {
            ...
            for (var i = 0; i < len; i++) {
                if (this._tabPairs[i] == val || this._tabPairs[i].name == val) {
                    var event = new Animate.TabEvent(TabEvents.REMOVED, this._tabPairs[i]);
        ...
        Object.defineProperty(Tab.prototype, "tabs", {
            get: function () { return this._tabPairs; },
            enumerable: true,
            configurable: true
        });
        return Tab;
...
(function (Animate) {
    ...
    */
    var TabPair = (function () {
        function TabPair(selector, page, name) {
            this.tab = null;
        ...
        Object.defineProperty(TabPair.prototype, "modified", {
            /**
        ...
        */
        ...
        ListView.prototype.onDoubleClick = function (e) {
            ...
            if (listViewItem) {
                ...
                this.emit(new Animate.ListViewEvent(ListViewEvents.ITEM_DOUBLE_CLICKED, listViewItem));
            }
            e.preventDefault();
            return false;
        };
            ...
            if (comp instanceof Animate.ListViewHeader) {
                ...
                if (listViewItem) {
                    if (!e.ctrlKey && jQuery(e.target).hasClass("selected")) {
                        ...
                        this.emit(new Animate.ListViewEvent(ListViewEvents.ITEM_CLICKED, null));
                        return;
                    }
                    ...
                    if (jQuery(e.target).hasClass("selected")) {
                        ...
                        this.emit(new Animate.ListViewEvent(ListViewEvents.ITEM_CLICKED, listViewItem));
                    }
                }
            }
        };
    ...
    var List = (function (_super) {
        ...
        */
        List.prototype.onSelection = function (val) {
            this.emit(new Animate.ListEvent(ListEvents.ITEM_SELECTED, this.selectedItem));
        };
        /**
    ...
    */
    var Application = (function (_super) {
        ...
        function Application(domElement) {
            ...
            Animate.Logger.getSingleton(leftSplit.bottom);
            Animate.Logger.logMessage("let's get animated!", null, Animate.LogType.MESSAGE);
            ...
            this._dockerleftbottom.addComponent(Animate.Logger.getSingleton(), false);
...
(function (Animate) {
    ...
    */
    var CanvasItem = (function (_super) {
        ...
        * Creates an instance
        */
        function CanvasItem(html, parent) {
            _super.call(this, html, parent);
            this.shallowId = Animate.Utils.generateLocalId();
        }
        /**
        * A shortcut for jQuery's css property.
        */
        CanvasItem.prototype.css = function (propertyName, value) {
            //Call super
            var toRet = this.element.css(propertyName, value);
            return toRet;
        };
        ...
        * @returns {ICanvasItem}
        */
        CanvasItem.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            var toRet = {};
        ...
        */
        CanvasItem.prototype.deTokenize = function (data) {
        ...
        */
        CanvasItem.prototype.link = function (originalId, items) {
        };
        return CanvasItem;
    })(Animate.Component);
    Animate.CanvasItem = CanvasItem;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    */
    var Behaviour = (function (_super) {
        ...
        * @returns {Portal}
        */
        Behaviour.prototype.getPortal = function (name) {
        ...
        * @returns {Portal}
        */
        Behaviour.prototype.addPortal = function (type, property, update, custom) {
            if (custom === void 0) { custom = false; }
            var portal = new Animate.Portal(this, type, property, custom);
            this._requiresUpdated = true;
            // Add the arrays
        ...
        * @returns {IBehaviour}
        */
        Behaviour.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            var toRet = _super.prototype.tokenize.call(this, slim);
            toRet.portals = [];
            for (var i = 0, portals = this.portals, l = portals.length; i < l; i++) {
                var portal = { name: portals[i].property.name, property: portals[i].property.tokenize(slim), type: portals[i].type };
                if (!slim)
        ...
        */
        Behaviour.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            ...
            for (var i = 0, portals = data.portals, l = portals.length; i < l; i++) {
                ...
                var prop = Animate.Utils.createProperty(portals[i].property.name, portals[i].property.type);
        ...
        */
        ...
        Object.defineProperty(Behaviour.prototype, "properties", {
...
(function (Animate) {
    var BehaviourPortal = (function (_super) {
        ...
        function BehaviourPortal(parent, property, portalType) {
            ...
            if (property) {
                ...
                this.element.addClass(Animate.PortalType[this._portalType].toLowerCase());
            }
        }
        /**
        * Tokenizes the data into a JSON.
        ...
        */
        BehaviourPortal.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
            this._portalType = data.portal.type;
            this.element.addClass(Animate.PortalType[this._portalType].toLowerCase());
            this._property = Animate.Utils.createProperty(data.portal.property.name, data.portal.property.type);
        ...
        */
        ...
        Object.defineProperty(BehaviourPortal.prototype, "property", {
...
(function (Animate) {
    var BehaviourAsset = (function (_super) {
        ...
        * @returns {IBehaviour}
        */
        BehaviourAsset.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            var toRet = _super.prototype.tokenize.call(this, slim);
            toRet.type = Animate.CanvasItemType.BehaviourAsset;
            return toRet;
        };
        /**
        * Adds a portal to this behaviour.
        ...
        * @returns {Portal}
        */
        BehaviourAsset.prototype.addPortal = function (type, property, update) {
            var portal = _super.prototype.addPortal.call(this, type, property, update);
            if (type == Animate.PortalType.PARAMETER)
                this._asset = property.getVal();
            return portal;
        };
...
(function (Animate) {
    ...
    */
    var BehaviourComment = (function (_super) {
       ...
       * @returns {IBehaviour}
       */
        BehaviourComment.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            var toRet = _super.prototype.tokenize.call(this, slim);
       ...
       */
        ...
        */
        BehaviourComment.prototype.onEdit = function (type, event, sender) {
...
(function (Animate) {
    ...
    */
    var Portal = (function (_super) {
        ...
        * @param {Prop<any>} property The property associated with this portal
        */
        function Portal(parent, type, property, custom) {
            if (custom === void 0) { custom = false; }
            // Call super-class constructor
            _super.call(this, "<div class='portal " + Animate.PortalType[type].toLowerCase() + "'></div>", parent);
            this._links = [];
            ...
            // Add events
            if (type == Animate.PortalType.PRODUCT || type == Animate.PortalType.OUTPUT)
        ...
        */
        Portal.prototype.edit = function (property) {
            var svgSize = 10;
            ...
            this.element.html("");
            // Create the SVG
            if (this._type == Animate.PortalType.PARAMETER)
            ...
            else if (this._type == Animate.PortalType.OUTPUT)
            ...
            else if (this._type == Animate.PortalType.INPUT)
        ...
        */
        Portal.prototype.checkPortalLink = function (source) {
            if (source.type == Animate.PortalType.OUTPUT && this.type == Animate.PortalType.INPUT)
                return true;
            else if (source.type == Animate.PortalType.PRODUCT && this.type == Animate.PortalType.PARAMETER) {
                if (this._property.type == null || this._property.type == Animate.PropertyType.OBJECT)
                    return true;
                else if (this._property.type == this._property.type)
                    return true;
                else if (Animate.PluginManager.getSingleton().getConverters(source._property.type, this._property.type) == null)
                    return false;
                else
                    return true;
            }
        ...
        */
        ...
        Object.defineProperty(Portal.prototype, "property", {
            get: function () { return this._property; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Portal.prototype, "customPortal", {
            ...
            set: function (val) { this._customPortal = val; },
            enumerable: true,
            configurable: true
        });
...
(function (Animate) {
    ...
    */
    var BehaviourInstance = (function (_super) {
        ...
        function BehaviourInstance(parent, container) {
        ...
        * @returns {IBehaviourResource}
        */
        BehaviourInstance.prototype.tokenize = function (slim) {
            if (slim === void 0) { slim = false; }
            var toRet = _super.prototype.tokenize.call(this, slim);
            toRet.type = Animate.CanvasItemType.BehaviourInstance;
            return toRet;
        };
        /**
        * De-Tokenizes data from a JSON.
        * @param {IBehaviourResource} data The data to import from
        */
        BehaviourInstance.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
        };
        /**
        * Called when a behaviour is disposed
        */
        BehaviourInstance.prototype.onContainerDeleted = function (type, event, sender) {
            if (event.container == this._container) {
                var canvas = this._container.canvas;
                if (canvas)
        ...
        */
        BehaviourInstance.prototype.onPortalChanged = function (type, event, sender) {
            ...
            else if (type == Animate.EventTypes.PORTAL_EDITED) {
                for (var i = 0, l = portals.length; i < l; i++)
                    if (portals[i].property.name == event.oldName) {
        ...
        Object.defineProperty(BehaviourInstance.prototype, "container", {
            ...
            */
            set: function (val) {
                ...
                // Remove events
                if (this._container) {
                    this._container.off(Animate.EventTypes.PORTAL_ADDED, this.onPortalChanged, this);
                    this._container.off(Animate.EventTypes.PORTAL_REMOVED, this.onPortalChanged, this);
                    this._container.off(Animate.EventTypes.PORTAL_EDITED, this.onPortalChanged, this);
                    this._container.off(Animate.EventTypes.CONTAINER_DELETED, this.onContainerDeleted, this);
                }
                this._container = val;
                if (!val)
                    return;
                val.on(Animate.EventTypes.PORTAL_ADDED, this.onPortalChanged, this);
                val.on(Animate.EventTypes.PORTAL_REMOVED, this.onPortalChanged, this);
                val.on(Animate.EventTypes.PORTAL_EDITED, this.onPortalChanged, this);
                val.on(Animate.EventTypes.CONTAINER_DELETED, this.onContainerDeleted, this);
                // Now that its created we need to create the starting portals. If the canvas exists we use that as a 
                // reference, otherwise we use the json
                var children = this._container.canvas.children;
                for (var ci = 0, cl = children.length; ci < cl; ci++)
                    if (children[ci] instanceof Animate.BehaviourPortal) {
                        var bPortal = children[ci];
                        var portals = bPortal.portals;
                        for (var pi = 0, l = portals.length; pi < l; pi++)
                            this.addPortal(bPortal.portaltype, portals[pi].property.clone(), false);
                    }
            },
    ...
    */
    var BehaviourScript = (function (_super) {
        ...
        function BehaviourScript(parent, scriptId, text, copied) {
            ...
            // Call super-class constructor
            _super.call(this, parent, "Script");
            // TODO: What do we do about shallow IDs?
            Animate.Utils.generateLocalId();
            this.scriptTab = null;
            ...
            if (scriptId && copied)
                ...
                promise = project.createResource(Animate.ResourceType.SCRIPT, { name: text });
            else
                promise = project.createResource(Animate.ResourceType.SCRIPT, { name: text, projectId: project.entry._id });
            promise.then(function (data) {
                Animate.Logger.logMessage("Created behaviour script '" + text + "'", null, Animate.LogType.MESSAGE);
        ...
        */
        BehaviourScript.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
    ...
    var Canvas = (function (_super) {
        ...
        */
        function Canvas(parent, container) {
            ...
            new Animate.BehaviourPortal(this, new Animate.PropBool("Start", false), Animate.PortalType.INPUT);
            // Hook listeners
            this.element.on("mousedown", this._downProxy);
        ...
        Canvas.prototype.onObjectDropped = function (event, ui) {
            ...
            if (comp instanceof Animate.TreeNode) {
                ...
                if (comp instanceof Animate.TreeNodeAssetInstance)
                    this.addAssetAtLocation(comp.resource, this._x, this._y);
                else if (comp instanceof Animate.TreeNodePluginBehaviour)
                    this.createNode(comp.template, this._x, this._y);
                else if (comp instanceof Animate.TreeNodeBehaviour)
                    this.createNode(Animate.PluginManager.getSingleton().getTemplate("Instance"), this._x, this._y, comp.resource);
            }
        };
        /**
        ...
        */
        Canvas.prototype.removeAsset = function (asset) {
            ...
            for (var i = 0, l = this.children.length; i < l; i++) {
                ...
                if (item instanceof Animate.Behaviour == false)
                    continue;
                var behaviour = item;
                for (var ii = 0, il = behaviour.parameters.length; ii < il; ii++) {
                    var portal = behaviour.parameters[ii];
                    if (portal.property.type != Animate.PropertyType.ASSET && portal.property.type != Animate.PropertyType.ASSET_LIST)
                        continue;
                    if (portal.property.getVal() == null)
                        continue;
                    var a = portal.property.getVal();
                    if (a instanceof Animate.Asset) {
                        if (a == asset) {
                            portal.property.setVal(null);
                            if (behaviour instanceof Animate.BehaviourAsset)
            ...
            for (var i = 0; i < toRemove.length; i++)
                if (toRemove[i] == item) {
                    ...
                    if (toRemove[i] instanceof Animate.BehaviourPortal)
                        this.emit(new Animate.PortalEvent(Animate.EventTypes.PORTAL_REMOVED, "", this._container, toRemove[i].portals[0]));
                    toRemove[i].dispose();
                    this.buildSceneReferences();
                }
            toRemove = null;
        ...
        */
        Canvas.prototype.onContextSelect = function (e, event) {
            ...
            if (event.item.text == "Delete") {
                // Delete portal
                if (context instanceof Animate.Portal) {
                    ...
                    Animate.PropertyGrid.getSingleton().editableObject(behaviour.properties, behaviour.text + " - " + behaviour.id, null);
                    return;
                }
                else
            ...
            else if (event.item.text == "Edit Portal" && context instanceof Animate.Portal) {
                Animate.PortalForm.getSingleton().editPortal(context.property, context.type, function (name) {
                ...
                var c = Animate.Application.getInstance().canvasContext;
                Animate.BehaviourPicker.getSingleton().show(Animate.Application.getInstance(), c.element.offset().left, c.element.offset().top, false, true);
            }
                ...
                Animate.PortalForm.getSingleton().editPortal(null, type, function (name) {
                    // Make sure there are no duplicates
                    if (context instanceof Animate.Behaviour) {
                        ...
                        for (var i = 0, children = that.children, l = children.length; i < l; i++)
                            if (children[i] instanceof Animate.BehaviourPortal)
                                if (children[i].property.name == name)
                                    return false;
                    return true;
                }).then(function (data) {
                    if (data.cancel)
                    ...
                    if (context instanceof Animate.Behaviour)
                        ...
                        var newNode = new Animate.BehaviourPortal(that, data.prop, type);
                        newNode.css({ "left": that._x + "px", "top": that._y + "px", "position": "absolute" });
                        // Notify of change
                        that.emit(new Animate.PortalEvent(Animate.EventTypes.PORTAL_ADDED, "", that._container, newNode.portals[0]));
                    }
                    // Notify of change
                    that.emit(new Animate.CanvasEvent(CanvasEvents.MODIFIED, this));
                });
            }
        ...
        */
        Canvas.prototype.getAssetList = function (asset, assetMap) {
            ...
            for (var i = 0, l = properties.length; i < l; i++)
                if (properties[i].type == Animate.PropertyType.ASSET)
                    this.getAssetList(properties[i].getVal(), assetMap);
                else if (properties[i].type == Animate.PropertyType.ASSET_LIST) {
                    var aList = properties[i].getVal();
                    for (var a = 0, al = aList.length; a < al; a++)
            ...
            for (var i = 0; i < children.length; i++) {
                if (children[i] instanceof Animate.Behaviour) {
                    ...
                    for (var ii = 0; ii < portals.length; ii++) {
                        ...
                        if (val instanceof Animate.Asset)
                            this.getAssetList(val, curAssets);
                        else if (val instanceof Animate.GroupArray)
        ...
        */
        Canvas.prototype.OnPortalConfirm = function (response, e) {
            if (this.element.is(':visible') == false)
                return;
            if (e.text == "Ok") {
                var comp = this._contextNode;
                // If we are editing a portal
                if (comp instanceof Animate.Portal) {
                    var portal = comp;
                    var oldName = portal.property.name;
                    portal.edit(Animate.PortalForm.getSingleton().getProperty());
                    ...
                    Animate.PropertyGrid.getSingleton().editableObject(behaviour.properties, behaviour.text + " - " + behaviour.id, "");
                    // Notify of change
                    this.emit(new Animate.PortalEvent(Animate.EventTypes.PORTAL_EDITED, oldName, this._container, portal));
                    return;
                }
                else if (comp instanceof Animate.Behaviour) {
                    // Create a portal on a Behaviour
                    var portal = comp.addPortal(Animate.PortalForm.getSingleton().portalType, Animate.PortalForm.getSingleton().getProperty(), true, true);
                }
                else {
                    // Create a canvas portal
                    var newNode = new Animate.BehaviourPortal(this, Animate.PortalForm.getSingleton().getProperty(), Animate.PortalForm.getSingleton().portalType);
                    //PortalForm.getSingleton().name,
                    //PortalForm.getSingleton().portalType,
                    //PortalForm.getSingleton().parameterType,
                    //PortalForm.getSingleton().value );
                    ...
                    // Notify of change
                    this.emit(new Animate.PortalEvent(Animate.EventTypes.PORTAL_ADDED, "", this._container, newNode.portals[0]));
                }
                // Notify of change
                this.emit(new Animate.CanvasEvent(CanvasEvents.MODIFIED, this));
            }
        ...
        */
        Canvas.prototype.isCyclicDependency = function (container, ref) {
            ...
            for (var i = 0, l = items.length; i < l; i++)
                if (items[i].type == Animate.CanvasItemType.BehaviourInstance) {
                    var childContainer = project.getResourceByShallowID(items[i].shallowId, Animate.ResourceType.CONTAINER);
        ...
        */
        Canvas.prototype.onDoubleClick = function (e) {
            ...
            if (comp instanceof Animate.BehaviourComment) {
                ...
                var node = tree.findNode("resource", comp.container);
        ...
        */
        Canvas.prototype.selectItem = function (comp) {
            if (comp == null) {
                ...
                Animate.PropertyGrid.getSingleton().editableObject(null, "", "");
            ...
            if (comp instanceof Animate.Behaviour) {
                ...
                if (comp instanceof Animate.BehaviourComment)
                    Animate.PropertyGrid.getSingleton().editableObject(comp.properties, "Comment", "");
                else if (comp instanceof Animate.BehaviourShortcut == false)
                    Animate.PropertyGrid.getSingleton().editableObject(comp.properties, comp.text + " - " + comp.id, "");
        ...
        */
        Canvas.prototype.addChild = function (child) {
            // Call super
            var toRet = _super.prototype.addChild.call(this, child);
            ...
            if (toRet instanceof Animate.Behaviour || toRet instanceof Animate.Link)
        ...
        */
        Canvas.prototype.tokenize = function (slim, items) {
            var children = items || this.children;
            var toRet = {
                items: [],
    ...
    var Link = (function (_super) {
        ...
        */
        Link.prototype.tokenize = function (slim) {
            ...
            toRet.frameDelay = this._properties.getVar("Frame Delay").getVal();
            toRet.type = Animate.CanvasItemType.Link;
            return toRet;
        };
        /**
        * De-Tokenizes data from a JSON.
        ...
        */
        Link.prototype.deTokenize = function (data) {
            _super.prototype.deTokenize.call(this, data);
       ...
       */
        ...
        */
        Link.prototype.onEdit = function (type, event, sender) {
            this.draw();
        };
        Object.defineProperty(Link.prototype, "properties", {
            /**
    ...
    var TreeViewScene = (function (_super) {
        ...
        */
        TreeViewScene.prototype.onResourceCreated = function (type, event) {
            ...
            else if (r instanceof Animate.GroupArray)
                this._groupsNode.addNode(new Animate.TreeNodeGroup(r));
            ...
            switch (selection) {
                ...
                case "Copy":
                    if (context instanceof Animate.TreeNodeAssetInstance) {
                        ...
                        resolveRequest(project.copyResource(context.resource.entry._id, Animate.ResourceType.ASSET), context);
                    }
                    break;
                case "Add Instance":
                    if (context instanceof Animate.TreeNodeAssetClass)
                        project.createResource(Animate.ResourceType.ASSET, { name: "New " + context.assetClass.name, className: context.assetClass.name });
                    break;
                case "Save":
                    selectedNodes.forEach(function (val, index) {
                        val.loading = true;
                ...
                case "Add Group":
                    context.loading = true;
                    promise = project.createResource(Animate.ResourceType.GROUP, { name: "New Group" }).then(function () {
        ...
        TreeViewScene.prototype.onDblClick = function (e) {
            if (this.selectedNode instanceof Animate.TreeNodeBehaviour) {
                ...
                if (tabPair)
                    ...
                    var tabPair = Animate.CanvasTab.getSingleton().addSpecialTab(this.selectedNode.text, Animate.CanvasTabType.CANVAS, this.selectedNode.resource);
    ...
    */
    var TreeNode = (function (_super) {
        ...
        */
        ...
        Object.defineProperty(TreeNode.prototype, "loading", {
            /**
...
(function (Animate) {
    ...
    */
    var TreeNodeResource = (function (_super) {
        __extends(TreeNodeResource, _super);
        function TreeNodeResource(resource, text, img, hasExpand) {
            // Call super-class constructor
            _super.call(this, text, img, hasExpand);
            this.resource = resource;
            this.canDelete = true;
            this.canUpdate = true;
        ...
        */
        TreeNodeResource.prototype.onDeleted = function (type, event, sender) {
            this.dispose();
        };
        /**
        * Called whenever the resource is modified
        */
        TreeNodeResource.prototype.onModified = function (type, event, sender) {
            this.modified = !this.resource.saved;
        };
        /**
        * Called when a draggable object is dropped onto the node
        */
        TreeNodeResource.prototype.onDropped = function (event, ui) {
            var comp = jQuery(ui.draggable).data("component");
        };
        /**
        * This will cleanup the component.
    ...
    Animate.TreeNodeResource = TreeNodeResource;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    var TreeNodeAssetInstance = (function (_super) {
        ...
        */
        function TreeNodeAssetInstance(assetClass, asset) {
            // Call super-class constructor
            _super.call(this, asset, (jQuery.trim(asset.entry.name) == "" ? "New " + assetClass.name : asset.entry.name), "media/variable.png", false);
            this.canCopy = true;
            this.canUpdate = true;
            this.assetClass = assetClass;
        ...
        */
        TreeNodeAssetInstance.prototype.onSelect = function () {
            Animate.PropertyGrid.getSingleton().editableObject(this.resource.properties, this.text + "  [" + this.resource.entry.shallowId + "]", "media/variable.png");
            Animate.PluginManager.getSingleton().emit(new Animate.AssetEvent(Animate.EditorEvents.ASSET_SELECTED, this.resource));
        };
        /**
        * When we click ok on the portal form
        * @param {string} type
        ...
        */
        TreeNodeAssetInstance.prototype.onAssetEdited = function (type, data, sender) {
    ...
    var TreeNodeBehaviour = (function (_super) {
        ...
        */
        function TreeNodeBehaviour(container) {
            // Call super-class constructor
            _super.call(this, container, container.entry.name, "media/variable.png", false);
            this.element.addClass("behaviour-to-canvas");
        ...
        */
        TreeNodeBehaviour.prototype.onSelect = function () {
            Animate.PropertyGrid.getSingleton().editableObject(this.resource.properties, this.text, "media/variable.png");
        };
        /**
        * Whenever a container property is changed by the editor
        */
        TreeNodeBehaviour.prototype.onPropertyGridEdited = function (type, event, sender) {
            this.resource.saved = false;
...
(function (Animate) {
    ...
    */
    var TreeNodeGroup = (function (_super) {
        ...
        function TreeNodeGroup(group) {
            // Call super-class constructor
            _super.call(this, group, group.entry.name, "media/array.png", true);
            ...
            for (var i = 0, items = group.entry.items, l = items.length; i < l; i++) {
                var resource = project.getResourceByShallowID(items[i]);
                this.addNode(new Animate.TreeNodeGroupInstance(resource.entry._id, resource.entry.name, group));
            }
        }
        /**
        * Called whenever the resource is re-downloaded
        ...
        * Called when a draggable object is dropped onto the canvas.
        */
        TreeNodeGroup.prototype.onDropped = function (event, ui) {
            var comp = jQuery(ui.draggable).data("component");
            if (comp instanceof Animate.TreeNodeAssetInstance || comp instanceof TreeNodeGroup) {
                ...
                if (comp instanceof Animate.TreeNodeAssetInstance) {
                    ...
                    added = this.addNode(new Animate.TreeNodeGroupInstance(entry.shallowId, entry.name, this.resource));
                }
...
(function (Animate) {
    ...
    */
    var TreeNodeGroupInstance = (function (_super) {
        ...
        function TreeNodeGroupInstance(instanceID, name, group) {
            // Call super-class constructor
        ...
        */
        ...
        Object.defineProperty(TreeNodeGroupInstance.prototype, "shallowId", {
...
(function (Animate) {
    ...
    */
    var CanvasTabPair = (function (_super) {
        ...
        */
        CanvasTabPair.prototype.onContainerModified = function (type, event, sender) {
        ...
        */
        ...
        Object.defineProperty(CanvasTabPair.prototype, "canvas", {
            /**
            * @returns {Canvas}
            */
        ...
        */
        HTMLTab.prototype.save = function () {
            ...
            Animate.User.get.project.curBuild.update({ html: editor.getValue() }).then(function () {
                ...
                that.loading(false);
                Animate.Logger.logMessage("Could not update the build HTML: '" + err.message + "'", null, Animate.LogType.ERROR);
            });
        };
        /**
        ...
        */
        CSSTab.prototype.save = function () {
            ...
            Animate.User.get.project.curBuild.update({ css: editor.getValue() }).then(function () {
                ...
                that.loading(false);
                Animate.Logger.logMessage("Could not update the build CSS: '" + err.message + "'", null, Animate.LogType.ERROR);
            });
        };
        /**
        * Gets the script initial values
        ...
        */
        ScriptTab.prototype.onAdded = function () {
            ...
            editor.commands.addCommand({
                ...
                exec: function () { Animate.Toolbar.getSingleton().saveAll(); }
            });
            var loader = new Animate.AnimateLoader();
        ...
        CanvasTab.prototype.onTabPairClosing = function (tabPair) {
            if (tabPair instanceof Animate.CanvasTabPair) {
                ...
                if (!tabPair.forceClose && tabPair.modified && !canvas.container.disposed) {
                    ...
                    Animate.PluginManager.getSingleton().emit(new Animate.ContainerEvent(Animate.EventTypes.CONTAINER_SELECTED, null));
            }
            return true;
        };
        /**
        ...
        */
        CanvasTab.prototype.getTabCanvas = function (behaviourID) {
            ...
            for (var i = 0, l = tabs.length; i < l; i++) {
                var t = tabs[i];
                if (t instanceof Animate.CanvasTabPair)
        ...
        CanvasTab.prototype.onTabSelected = function (tab) {
            ...
            if (this._currentCanvas && !this._currentCanvas.disposed) {
                ...
                for (var i = 0, l = references.assets.length; i < l; i++) {
                    var asset = project.getResourceByShallowID(references.assets[i], Animate.ResourceType.ASSET);
            ...
            if (this._currentCanvas != null && this._currentCanvas.element.data("component") instanceof Animate.Canvas) {
                ...
                canvas.onSelected();
                var node = Animate.TreeViewScene.getSingleton().sceneNode.findNode("resource", canvas.container);
                if (node)
                ...
                pManager.emit(new Animate.ContainerEvent(Animate.EventTypes.CONTAINER_SELECTED, canvas.container));
            }
            else
                // We tell the plugins we've selected a behaviour container
                pManager.emit(new Animate.ContainerEvent(Animate.EventTypes.CONTAINER_SELECTED, null));
        ...
        */
        CanvasTab.prototype.addSpecialTab = function (text, type, tabContent) {
            ...
            if (type == CanvasTabType.CANVAS) {
                ...
                pManager.emit(new Animate.ContainerEvent(Animate.EventTypes.CONTAINER_CREATED, tabContent));
                pManager.emit(new Animate.ContainerEvent(Animate.EventTypes.CONTAINER_SELECTED, tabContent));
            }
...
(function (Animate) {
    ...
    */
    var PGTextbox = (function (_super) {
        __extends(PGTextbox, _super);
        function PGTextbox(grid) {
        ...
        * @returns {boolean}
        */
        PGTextbox.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropText)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PGTextbox.prototype.edit = function (prop, container) {
            var p = prop;
            // Create HTML
            var editor = jQuery("<div class='property-grid-label'>" + p.name + "</div><div class='property-grid-value'><input type='text' class='PropTextbox' value = '" + p.getVal().toString() + "' /></div><div class='fix'></div>");
            var that = this;
            // Add to DOM
...
(function (Animate) {
    ...
    */
    var PGNumber = (function (_super) {
        __extends(PGNumber, _super);
        function PGNumber(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGNumber.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropNum)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PGNumber.prototype.edit = function (prop, container) {
            var p = prop;
            //Create HTML
            var num = p.getVal();
            var min = p.min;
            ...
            // Create HTML
            var editor = jQuery("<div class='property-grid-label'>" + p.name + "</div><div class='property-grid-value'><input type='text' class='PropTextbox' value = '" + num + "' /></div><div class='fix'></div>");
            // Add to DOM
            container.element.append(editor);
            var that = this;
            // Function to deal with user interactions with JQuery
...
(function (Animate) {
    ...
    */
    var PGComboBool = (function (_super) {
        __extends(PGComboBool, _super);
        function PGComboBool(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGComboBool.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropBool)
                return true;
            else
                return false;
        };
    ...
    Animate.PGComboBool = PGComboBool;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    */
    var PGComboEnum = (function (_super) {
        __extends(PGComboEnum, _super);
        function PGComboEnum(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGComboEnum.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropEnum)
                return true;
            else
                return false;
        };
    ...
    Animate.PGComboEnum = PGComboEnum;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    */
    var PGFile = (function (_super) {
        __extends(PGFile, _super);
        function PGFile(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGFile.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropFileResource)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PGFile.prototype.edit = function (prop, container) {
            var p = prop;
...
(function (Animate) {
    ...
    */
    var PGComboGroup = (function (_super) {
        __extends(PGComboGroup, _super);
        function PGComboGroup(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGComboGroup.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropGroup)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PGComboGroup.prototype.edit = function (prop, container) {
            var p = prop;
            var group = p.getVal();
            ...
            var onSelect = function (e) {
                ...
                var group = project.getResourceByShallowID(val, Animate.ResourceType.GROUP);
                p.setVal(group);
            };
            var onEye = function (e) {
                var val = parseFloat(selector.val());
                var group = project.getResourceByShallowID(val, Animate.ResourceType.GROUP);
                Animate.TreeViewScene.getSingleton().selectNode(Animate.TreeViewScene.getSingleton().findNode("resource", group), true);
            };
            //Add listeners
    ...
    Animate.PGComboGroup = PGComboGroup;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    * This represents a combo property for assets that the user can select from a list.
    */
    var PGComboAsset = (function (_super) {
        __extends(PGComboAsset, _super);
        function PGComboAsset(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGComboAsset.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropAsset && prop.type == Animate.PropertyType.ASSET)
                return true;
            else
                return false;
        };
        ...
        */
        PGComboAsset.prototype.edit = function (prop, container) {
            ...
            var onSelect = function (e) {
                var val = parseFloat(selector.val());
                var asset = Animate.User.get.project.getResourceByShallowID(val, Animate.ResourceType.ASSET);
                p.setVal(asset);
            };
            ...
            var onEye = function (e) {
                ...
                var asset = Animate.User.get.project.getResourceByShallowID(val, Animate.ResourceType.ASSET);
                if (asset)
                    Animate.TreeViewScene.getSingleton().selectNode(Animate.TreeViewScene.getSingleton().findNode("resource", asset), true);
                else
    ...
    Animate.PGComboAsset = PGComboAsset;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    */
    var PGAssetList = (function (_super) {
        __extends(PGAssetList, _super);
        function PGAssetList(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGAssetList.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropAssetList)
                return true;
            else
                return false;
        };
        ...
        */
        PGAssetList.prototype.edit = function (prop, container) {
            ...
            var onSelect = function (e) {
                ...
                asset = Animate.User.get.project.getResourceByShallowID(assetId, Animate.ResourceType.ASSET);
            };
            ...
            var onEye = function (e) {
                var val = parseInt(selector.val());
                asset = Animate.User.get.project.getResourceByShallowID(val, Animate.ResourceType.ASSET);
                if (asset)
                    Animate.TreeViewScene.getSingleton().selectNode(Animate.TreeViewScene.getSingleton().findNode("resource", asset), true);
                else
                    Animate.TreeViewScene.getSingleton().selectNode(Animate.TreeViewScene.getSingleton().findNode("className", asset.class.name), true);
            };
            ...
            var onRemove = function (e) {
                ...
                asset = Animate.User.get.project.getResourceByShallowID(toRemove, Animate.ResourceType.ASSET);
    ...
    Animate.PGAssetList = PGAssetList;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    */
    var PGColorPicker = (function (_super) {
        __extends(PGColorPicker, _super);
        function PGColorPicker(grid) {
            _super.call(this, grid);
        }
        /**
        * Checks a property to see if it can edit it
        ...
        * @returns {boolean}
        */
        PGColorPicker.prototype.canEdit = function (prop) {
            if (prop instanceof Animate.PropColor)
                return true;
            else
                return false;
        };
        ...
        * @param {Component} container The container acting as this editors parent
        */
        PGColorPicker.prototype.edit = function (prop, container) {
            var p = prop;
            ...
            container.element.append(editor);
            var myPicker = new jscolor.color(document.getElementById(_id1), {});
            ...
            var onValueEdited = function (e) {
                ...
                prop.setVal(new Animate.Color(col, alpha));
            };
            //Add listeners
    ...
    Animate.PGColorPicker = PGColorPicker;
})(Animate || (Animate = {}));
var Animate;
(function (Animate) {
    /**
    ...
    */
    var PropertyGrid = (function (_super) {
        ...
        function PropertyGrid(parent) {
            ...
            this._docker = null;
            this._groups = [];
            this.addEditor(new Animate.PGTextbox(this));
            this.addEditor(new Animate.PGNumber(this));
            this.addEditor(new Animate.PGComboBool(this));
            this.addEditor(new Animate.PGComboEnum(this));
            this.addEditor(new Animate.PGComboGroup(this));
            this.addEditor(new Animate.PGColorPicker(this));
            this.addEditor(new Animate.PGFile(this));
            this.addEditor(new Animate.PGAssetList(this));
            //this.addEditor( new PropOptionsWindow( this ) );
            this.addEditor(new Animate.PGComboAsset(this));
        }
        /**
        * This is called by a controlling ScreenManager class. An image string needs to be returned
        * which will act as a preview of the component that is being viewed or hidden.
        ...
        */
        PropertyGrid.prototype.cleanup = function () {
            // Cleanup editors
        ...
        */
        PropertyGrid.prototype.editableObject = function (object, name, img) {
            if (img === void 0) { img = ""; }
            if (!this.enabled)
                return;
            // Cleanup
            ...
            if (object !== undefined && object != null) {
                ...
                for (var i = 0; i < sortable.length; i++) {
                    ...
                    for (var editor = 0, el = editors.length; editor < el; editor++) {
                        if (sortable[i].prop.type == Animate.PropertyType.HIDDEN || sortable[i].prop.type == Animate.PropertyType.HIDDEN_FILE)
                            continue;
                        if (!editors[editor].canEdit(sortable[i].prop))
                            continue;
                        var editorContainer = new Animate.Component("<div class='editor-container'></div>");
        ...
        */
        ToolbarNumber.prototype.onStageUp = function (e) {
            ...
            if (inputOnDOM) {
                ...
                this.emit(new Animate.ToolbarNumberEvent(ToolbarNumberEvents.CHANGED, this.defaultVal));
            }
        };
        /**
        ...
        Object.defineProperty(ToolbarDropDown.prototype, "selectedItem", {
            ...
            */
            set: function (item) {
                ...
                var e = new Animate.ToolbarDropDownEvent(item, "clicked");
                this.emit(e);
                e.dispose();
                return;
            },
    ...
    var OkCancelForm = (function (_super) {
        ...
        */
        OkCancelForm.prototype.onCloseClicked = function (e) {
            var event = new Animate.OkCancelFormEvent(OkCancelFormEvents.CONFIRM, "Cancel");
            this.emit(event);
            if (event.cancel === false)
                this.hide();
        };
        ...
        */
        OkCancelForm.prototype.OnButtonClick = function (e) {
            var event = new Animate.OkCancelFormEvent(OkCancelFormEvents.CONFIRM, jQuery(e.target).text());
            this.emit(event);
            if (event.cancel === false)
                this.hide();
        };
    ...
    var FileViewer = (function (_super) {
        ...
        */
        function FileViewer() {
            ...
            this.$editMode = false;
            this._searchType = Animate.FileSearchType.User;
            this.$fileToken = { tags: [] };
            ...
            searchOptions.on("clicked", function (e, event, sender) {
                if (sender.selectedItem.text == "Filter by Project Files")
                    that.selectMode(Animate.FileSearchType.Project);
                else if (sender.selectedItem.text == "Filter by My Files")
                    that.selectMode(Animate.FileSearchType.User);
                else
                    that.selectMode(Animate.FileSearchType.Global);
            });
            // Make the form resizable
            this.element.resizable({
                minHeight: 50,
        ...
        */
        FileViewer.prototype.hide = function () {
            this.emit(new Animate.FileViewerEvent("selected", (this._cancelled ? null : this.selectedEntity)));
            _super.prototype.hide.call(this);
        ...
        */
        FileViewer.prototype.updateContent = function (index, limit) {
            ...
            //if (this.selectedFolder)
            //{
            if (this._searchType == Animate.FileSearchType.Project)
            ...
            var fu = new Animate.FileUploader(function (p) {
                ...
                if (err) {
                    ...
                    Animate.Utils.put(Animate.DB.API + "/files/" + details.username + "/" + file._id, { previewUrl: tokens[1].url }).then(function (token) {
                        ...
                        Animate.Logger.logMessage("An error occurred while connecting to the server. " + err.status + ": " + err.message, null, Animate.LogType.ERROR);
                    });
                }
            });
    ...
    */
    var PortalForm = (function (_super) {
        ...
        function PortalForm() {
            ...
            // Call super-class constructor
            _super.call(this, 400, 250, true, true, "Portal Editor");
            ...
            this.onTypeSelect(Animate.ListEvents.ITEM_SELECTED, new Animate.ListEvent(Animate.ListEvents.ITEM_SELECTED, Animate.PropertyType.ASSET.toString()));
            // Fetch & compile the HTML
            this._formElm = jQuery("#portal-editor").remove().clone();
            this.content.element.append(this._formElm);
            Animate.Compiler.build(this._formElm, this, false);
        ...
        */
        PortalForm.prototype.generateClasses = function () {
            // Clear cobos
            ...
            for (var p in Animate.PropertyType)
        ...
        * @param {Prop<any>}
        */
        PortalForm.prototype.getProperty = function () {
            return new Animate.Prop(this.$name, this._value);
        };
        /**
        * Shows the window by adding it to a parent.
        ...
        */
        ...
        PortalForm.prototype.editPortal = function (property, type, nameVerifier) {
            ...
            if (type == Animate.PortalType.OUTPUT || type == Animate.PortalType.INPUT) {
                ...
                this.onTypeSelect(Animate.ListEvents.ITEM_SELECTED, new Animate.ListEvent(Animate.ListEvents.ITEM_SELECTED, this._typeCombo.selectedItem));
            }
            //if ( item instanceof Portal )
            ...
            this._fromOk = false;
            Animate.Compiler.digest(this._formElm, this);
            //(<Label>this._name.val).textfield.element.focus();
        ...
        */
        PortalForm.prototype.hide = function () {
            if (!this._fromOk)
        ...
        * and pass the text either for the ok or cancel buttons.
        */
        PortalForm.prototype.ok = function () {
            ...
            if (newName.trim() == "") {
                this.$errorMsg = "Name cannot be empty";
                return Animate.Compiler.digest(this._formElm, this);
            }
            if (this._typeCombo.selectedIndex == 0 && (this._portalType == Animate.PortalType.PARAMETER || this._portalType == Animate.PortalType.PRODUCT)) {
                this.$errorMsg = "Please select a valid property type";
                return Animate.Compiler.digest(this._formElm, this);
            }
            if (this._typeCombo.selectedItem == Animate.PropertyType[Animate.PropertyType.ASSET] && this._assetClassCombo.selectedIndex == 0) {
            ...
            //}
            //}
            if (this._portalType == Animate.PortalType.INPUT || this._portalType == Animate.PortalType.OUTPUT)
                this._newProperty = new Animate.PropBool(this.$name, false);
            else
                this._newProperty = Animate.Utils.createProperty(this.$name, Animate.PropertyType[this._typeCombo.selectedItem]);
            if (this._newProperty instanceof Animate.PropAsset && this._newProperty.type == Animate.PropertyType.ASSET) {
                if (this._assetClassCombo.selectedIndex < 2)
                    this._newProperty.classNames = [];
                else
                    this._newProperty.classNames = [this._assetClassCombo.selectedItem];
            }
            if (!this._nameVerifier(this.$name)) {
                this.$errorMsg = "The name " + this.$name + " is already in use, please choose another";
                return Animate.Compiler.digest(this._formElm, this);
            }
            this.emit(new Animate.Event("property-created"));
            this._fromOk = true;
            this.hide();
            return;
        ...
        Object.defineProperty(PortalForm.prototype, "value", {
            ...
            get: function () { return this._newProperty.getVal(); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PortalForm.prototype, "parameterType", {
            get: function () {
                if (this._portalType != Animate.PortalType.INPUT && this._portalType != Animate.PortalType.OUTPUT)
                    ...
                    return Animate.PropertyType.BOOL;
            },
            enumerable: true,
            configurable: true
        });
    ...
    var RenameForm = (function (_super) {
        ...
        */
        RenameForm.prototype.ok = function () {
            ...
            var event = new Animate.RenameFormEvent("renaming", name, prevName, this.object, this._type);
            this.$loading = true;
            this.$errorMsg = "";
            ...
            if (!this._resourceId || !this._type) {
                that.hide();
                return that.emit(new Animate.RenameFormEvent("renamed", name, prevName, that.object, that._type));
            }
            // Attempt to connect to the DB and update the object
            proj.editResource(this._resourceId, { name: name }, this._type).then(function (resp) {
                that.emit(new Animate.RenameFormEvent("renamed", name, prevName, that.object, that._type));
                that.hide();
                that.$loading = false;
    ...
    var BehaviourPicker = (function (_super) {
        ...
        */
        BehaviourPicker.prototype.onListDClick = function (e) {
            this.emit(new Animate.BehaviourPickerEvent(BehaviourPickerEvents.BEHAVIOUR_PICKED, this._list.selectedItem));
            this.hide();
        };
        /**
    ...
    var Splash = (function () {
        ...
        */
        Splash.prototype.openProject = function (project) {
            ...
            for (var i = 0, l = project.$plugins.length; i < l; i++)
                Animate.PluginManager.getSingleton().loadPlugin(project.$plugins[i]).then(function () {
                    Animate.Compiler.digest(that._splashElm, that, true);
        ...
        */
        Splash.prototype.loadScene = function () {
            ...
            Animate.Logger.logMessage("Loading project '" + that.$selectedProject.name + "'...", null, Animate.LogType.MESSAGE);
            // Attempts to load all the project resources
            project.loadResources().then(function (resources) {
                Animate.Logger.logMessage("Loaded [" + resources.length + "] resources", null, Animate.LogType.MESSAGE);

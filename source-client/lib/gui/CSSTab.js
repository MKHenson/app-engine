...
(function (Animate) {
    ...
    */
    var CSSTab = (function (_super) {
        ...
        */
        CSSTab.prototype.onSaveAll = function () {
            this._editor.setValue(Animate.User.getSingleton().project.mCurBuild.css);
        ...
        */
        CSSTab.prototype.onMessage = function (val) {
            if (val == "Yes") {
                ...
                Animate.User.getSingleton().project.saveBuild(build.build_notes, build.visibility, (Animate.HTMLTab.singleton ? Animate.HTMLTab.singleton.editor.getValue() : build.html), this._editor.getValue());
            } else {
                this.saved = true;
                Animate.CanvasTab.getSingleton().removeTab(this, true);
            }
        ...
        */
        CSSTab.prototype.onRemove = function (data) {
            ...
            Animate.HTMLTab.singleton = null;
            this._editor = null;
        };
...
//# sourceMappingURL=CSSTab.js.map

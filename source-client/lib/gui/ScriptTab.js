    ...
    var ScriptTab = (function (_super) {
        ...
        */
        ScriptTab.prototype.onAdded = function () {
            ...
            var databaseID = this.scriptNode.databaseID;
            var tab = this;
        ...
        */
        ScriptTab.prototype.onSelected = function () {
            ...
            len = portals.length;
            for (var i = 0; i < len; i++) {
                scripts[portals[i].name] = "this.exit( \"" + portals[i].name + "\", false, false );";
        ...
        */
        ScriptTab.prototype.save = function () {
            ...
            loader.load(Animate.DB.HOST, {
                category: "script",
                command: "saveScript",
                databaseID: this.scriptNode.databaseID,
...
//# sourceMappingURL=ScriptTab.js.map

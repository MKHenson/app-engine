	...
	*/
	export class UserPreferences extends Component implements ISettingsPage
	{
		...
		constructor( name? : string )
		{
			...
			this.userImgButton = <Component>group.content.addChild( "<div class='tool-bar-group'><div class='tab-button'><div><img src='media/add-asset.png' /></div><div class='tool-bar-text'>Add</div></div></div>" );

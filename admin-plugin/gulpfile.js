...
gulp.task('install-definitions', function () {
     return Promise.all([
            ...
            getDefinition("https://raw.githubusercontent.com/MKHenson/modepress/dev/server/dist/definitions/modepress-client.d.ts", "lib/definitions/required/", "modepress-client.d.ts")
         ]);
});
